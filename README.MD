...
This first weekend project set the tone of the following challenges because here I've learnt how to use doubles, stubbing and mocking and got to grips with the concepts of unit and feature tests.
